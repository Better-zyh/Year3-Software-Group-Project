...
//                System.out.println(request.getMethod());
    ...
    private boolean isProtectedUrl(HttpServletRequest request) {
        ...
        protectedPaths.add("/user/getuserinfo");
        protectedPaths.add("/verify");
        protectedPaths.add("/user/getHistory");
        protectedPaths.add("/user/getLikedPost");
        protectedPaths.add("/user/frozen");
        protectedPaths.add("/user/upload");
        protectedPaths.add("/post/create");
        protectedPaths.add("/post/update");
        protectedPaths.add("/post/setlike/*");
        protectedPaths.add("/post/cancelLike/*");
